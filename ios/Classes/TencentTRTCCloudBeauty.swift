...
public class TencentTRTCCloudBeauty: NSObject, FlutterPlugin, TRTCCloudDelegate {
	...
	public static func register(with registrar: FlutterPluginRegistrar) {
		...
		let instance = TencentTRTCCloudBeauty()
		
		TencentTRTCCloudBeauty.channel = channel;
        TencentTRTCCloudBeauty.registrar = registrar;
	...
	public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
		...
		case "sharedInstance":
			...
			break;
		case "setLicence":
			beautyManager!.setLicence(call: call, result: result);
			break;
        case "getLicenceInfo":
            beautyManager!.getLicenceInfo(call: call,result: result);
            break;
		...
		case "setGreenScreenFile":
			beautyManager!.setGreenScreenFile(call: call, result: result);
			break;
		...
		case "setForeheadLevel":
			...
			break;
		case "setMotionTmpl":
			beautyManager!.setMotionTmpl(call: call, result: result);
			break;
		case "setMotionMute":
			beautyManager!.setMotionMute(call: call, result: result);
			break;
	...
	*/
	public func sharedInstance(call: FlutterMethodCall, result: @escaping FlutterResult) {
		listener = Listener();
        cloudManager = CloudManager(registrar: TencentTRTCCloudBeauty.registrar);
	...
	*/
	public func getBeautyManager(call: FlutterMethodCall, result: @escaping FlutterResult) {
		beautyManager = BeautyManager(registrar: TencentTRTCCloudBeauty.registrar)
		result(nil);
	}
	...
	*/
	static func invokeListener(type: ListenerType, params: Any?) {
		...
		TencentTRTCCloudBeauty.channel!.invokeMethod(TencentTRTCCloudBeauty.LISTENER_FUNC_NAME, arguments: JsonUtil.toJson(resultParams));
	}
